...
import pacman.entries.pacman.MyPacManANN;
import pacman.entries.pacman.MyPacManBT;
...
{
    private static MyPacManANN myPacManANN;
...
//		MyPacManANN.setUpArtificialNeuralNetwork();
...
//		MyPacManANN.setUpArtificialNeuralNetwork();
//		MyPacManANN.saveNeuralNet = true;
//		MyPacManANN.trainingMode = true;
//		int loop = 0; while (loop++ < 1000) exec.runGame(new MyPacManBT(), new RandomGhosts(), false, 0);
//		exec.runGameTimed(new MyPacManBT(), new RandomGhosts(), visual);
		exec.runGameTimed(myPacManANN = new MyPacManANN(), new RandomGhosts(), visual);
	}
