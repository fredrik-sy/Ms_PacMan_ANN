 ...
 * MyPacManBT.zip and you will be entered into the rankings - as simple as that! Feel free to modify
...
{	
	...
	{			
		...
		//Strategy 1: if any non-edible ghost is too close (less than DETECT_DISTANCE), run away
